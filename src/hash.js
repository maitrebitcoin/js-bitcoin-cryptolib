...
function sha512( buffer ) {
   ...
   // right rotate x of bits bits, result forced in unsigned int 64 bits
    ...
    function ui64NewArrayFromBigIntArray( srcArry ) {
        var tab = []
        for (var i=0;i<srcArry.length;i++) {
            var res =  {}    
            var numI = BigInt(srcArry[i]);
            res.high = Number(numI / _2pow32) 
            res.low  = Number(numI % _2pow32) 
            tab.push(res)
        }
        return tab
    }
    ...
    const  H_ =   ["0x6a09e667f3bcc908", "0xbb67ae8584caa73b", "0x3c6ef372fe94f82b", "0xa54ff53a5f1d36f1", 
                   "0x510e527fade682d1", "0x9b05688c2b3e6c1f", "0x1f83d9abfb41bd6b", "0x5be0cd19137e2179" ] ;     
    var H = ui64NewArrayFromBigIntArray(H_)
    //  (first 64 bits of the fractional parts of the cube roots of the first 64 primes 2..311): 
    const K_ =    ["0x428a2f98d728ae22", "0x7137449123ef65cd", "0xb5c0fbcfec4d3b2f", "0xe9b5dba58189dbbc", "0x3956c25bf348b538", 
    ...
    var K =    ui64NewArrayFromBigIntArray(K_)                                 
